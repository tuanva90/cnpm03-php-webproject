<?php
class Admin_Form_UserEdit extends Zend_Form{
	public function init(){
		...
		$femail->addFilters(array(new Zend_Filter_StringTrim(),new Zend_Filter_StringToLower()));
		...
		$rdgroupuser->addMultiOptions(array('admin'=>'Admin', 'register'=>'Register', 'manager'=>'Manager'));
		...
		$this->addElements(array($fpassword,$fcfpassword,$femail,$freemail,$fdate,$fbluser,$rdgroupuser,$fbtnsave,$fbtnsave_close,$fbtnsave_new,$fbtncancel));
		$this->addDecorator('formElements');
		$this->addDecorator('form');
		
		$this->addDisplayGroup(	array('password','cfpassword','email','date','reemail','blockuser'),'Userdetails');
