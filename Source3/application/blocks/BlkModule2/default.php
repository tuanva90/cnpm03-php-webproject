<div class="ui-widget-content ui-conner-all module" id="<?php echo $info['module_id'];?>">
	...
	$(function() {
    	...
    	$("#edit-module2").button().click(function() {
			$("#edit-module2-form").dialog("open");
		});		
		});
	</script>
	<div class="ui-widget-header ui-corner-all module-title">
		...
		<div class="edit-button">
			<button id='edit-module2' class="state-changable-button">...</button>
		</div>
	</div>
	<p>Content of <?php echo $info['name'];?> goes here.</p>
	<!-- ////////////////////// -->
    <div id="edit-module2-form" title="Edit Contact Module">
		<form>
			<input type="checkbox" name="chkModule2IsShowed" id=chkIsShowed checked="checked"/>Use this module.<br>			
		</form>
	</div>
</div>