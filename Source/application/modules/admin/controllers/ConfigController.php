...
class Admin_ConfigController extends Honey_Controller_Action {
	...
	public function appAction() {
		...
		$this->view->assign ( 'languages', Honey_Language::getAvailableLanguages () );
		...
		//if (isset($config['production']['resources']['frontController']['plugins']['offlineMessage'])) {
			...
			$this->_helper->getHelper ( 'FlashMessenger' )
						  ->addMessage ( $this->view->cmsTranslator ( 'install_config_success' ) );
	...
	public function mailAction()
	{
		...
		if ($this->_request->isPost ()) {
			...
			$this->_helper->getHelper('FlashMessenger')
				->addMessage($this->view->cmsTranslator('config_server_success'));
